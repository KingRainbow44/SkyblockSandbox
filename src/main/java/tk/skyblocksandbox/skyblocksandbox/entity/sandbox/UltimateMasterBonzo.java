...
public final class UltimateMasterBonzo extends SandboxEntity {
    public UltimateMasterBonzo() {
    ...
    public SkyblockEntityData getEntityData() {
        ...
        entityData.entityName = "Ultimate Bonzo";
        entityData.health = 2000000000L;
        entityData.damage = 20000000;
