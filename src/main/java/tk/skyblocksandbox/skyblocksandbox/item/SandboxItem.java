...
public abstract class SandboxItem {
    ...
    protected void addNbt(ItemStack item) {
        ...
        nbt.setInteger("bonusDamage", 0); nbt.setInteger("bonusStrength", 0); nbt.setInteger("bonusDefense", 0);
        nbt.setInteger("bonusHealth", 0); nbt.setInteger("bonusIntelligence", 0); nbt.setInteger("bonusCritDamage", 0);
        nbt.setInteger("bonusCritChance", 0); nbt.setInteger("bonusAttackSpeed", 0); nbt.setInteger("bonusSpeed", 0);
        nbt.setInteger("bonusTrueDefense", 0); nbt.setInteger("bonusSeaCreatureChance", 0); nbt.setInteger("bonusMagicFind", 0);
        nbt.setInteger("bonusPetLuck", 0); nbt.setInteger("bonusAbilityDamage", 0); nbt.setInteger("bonusFerocity", 0);
        nbt.setInteger("bonusFarmingFortune", 0);

        //<editor-fold desc="Enchantments">
        nbt.setInteger("aiming", 0); nbt.setInteger("baneofarthropods", 0); nbt.setInteger("blessing", 0); nbt.setInteger("cleave", 0); nbt.setInteger("critical", 0); nbt.setInteger("depthstrider", 0);
        nbt.setInteger("enderslayer", 0); nbt.setInteger("expertise", 0); nbt.setInteger("fireprotection", 0); nbt.setInteger("fortune", 0); nbt.setInteger("giantkiller", 0); nbt.setInteger("impaling", 0);
        nbt.setInteger("lethality", 0); nbt.setInteger("luck", 0); nbt.setInteger("magnet", 0); nbt.setInteger("power", 0); nbt.setInteger("protection", 0); nbt.setInteger("rejuvenate", 0);
        nbt.setInteger("respite", 0); nbt.setInteger("silktouch", 0); nbt.setInteger("snipe", 0); nbt.setInteger("syphon", 0); nbt.setInteger("thunderbolt", 0); nbt.setInteger("triplestrike", 0);
        nbt.setInteger("vampirism", 0); nbt.setInteger("angler", 0); nbt.setInteger("bigbrain", 0); nbt.setInteger("caster", 0); nbt.setInteger("compact", 0); nbt.setInteger("cubism", 0);
        nbt.setInteger("dragonhunter", 0); nbt.setInteger("execute", 0); nbt.setInteger("featherfalling", 0); nbt.setInteger("firststrike", 0); nbt.setInteger("frail", 0); nbt.setInteger("growth", 0);
        nbt.setInteger("infinitequiver", 0); nbt.setInteger("lifesteal", 0); nbt.setInteger("luckofthesea", 0); nbt.setInteger("overload", 0); nbt.setInteger("projectileprotection", 0); nbt.setInteger("punch", 0);
        nbt.setInteger("replenish", 0); nbt.setInteger("scavenger", 0); nbt.setInteger("smelthingtouch", 0); nbt.setInteger("spikedhook", 0); nbt.setInteger("telekinesis", 0); nbt.setInteger("thunderlord", 0);
        nbt.setInteger("trueprotection", 0);  nbt.setInteger("venomous", 0); nbt.setInteger("aquaaffinity", 0); nbt.setInteger("blastprotection", 0); nbt.setInteger("chance", 0); nbt.setInteger("counterstrike", 0);
        nbt.setInteger("cultivating", 0); nbt.setInteger("efficiency", 0); nbt.setInteger("experience", 0); nbt.setInteger("fireaspect", 0); nbt.setInteger("flame", 0); nbt.setInteger("frostwalker", 0);
        nbt.setInteger("harvesting", 0); nbt.setInteger("knockback", 0); nbt.setInteger("looting", 0); nbt.setInteger("lure", 0); nbt.setInteger("piercing", 0); nbt.setInteger("prosecute", 0);
        nbt.setInteger("rainbow", 0); nbt.setInteger("respiration", 0); nbt.setInteger("sharpness", 0); nbt.setInteger("silktouch", 0); nbt.setInteger("smite", 0); nbt.setInteger("sugarrush", 0);
        nbt.setInteger("thorns", 0); nbt.setInteger("titankiller", 0); nbt.setInteger("vicious", 0);
        //</editor-fold>
    ...
    public static final int PET = 16;
