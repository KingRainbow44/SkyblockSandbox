...
public final class GoldorBoots extends SandboxItem {

    public GoldorBoots() {
        super(Material.LEATHER_BOOTS, "Goldor's Boots", SkyblockItemIds.GOLDOR_BOOTS);
    }
    ...
    public SkyblockItemData getItemData() {
        ...
        itemData.baseHealth = 190;
        itemData.baseDefense = 165;
