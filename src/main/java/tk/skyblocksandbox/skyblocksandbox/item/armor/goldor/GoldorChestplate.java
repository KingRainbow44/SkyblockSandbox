...
public final class GoldorChestplate extends SandboxItem {

    public GoldorChestplate() {
        super(Material.LEATHER_CHESTPLATE, "Goldor's Chestplate", SkyblockItemIds.GOLDOR_CHESTPLATE);
    }
    ...
    public SkyblockItemData getItemData() {
        ...
        itemData.baseHealth = 310;
        itemData.baseDefense = 275;
