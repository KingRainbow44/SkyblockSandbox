...
public final class StormLeggings extends SandboxItem {

    public StormLeggings() {
        super(Material.LEATHER_LEGGINGS, "Storm's Leggings", SkyblockItemIds.STORM_LEGGINGS);
    }
