...
public final class Valkyrie extends SandboxItem {

    public Valkyrie() {
        super(Material.IRON_SWORD, "Valkyrie", SkyblockItemIds.VALKYRIE);
    }
    ...
    public Collection<String> getLore() {
        Lore generator = new Lore(16,
                ...
                Utility.colorize("&7and &a+1&c ❁ Strength"),
    ...
    public SkyblockItemData getItemData() {
        ...
        finalItemData.baseDamage = 270;
        finalItemData.baseStrength = 145;
        finalItemData.baseIntelligence = 60;
        finalItemData.baseFerocity = 60;
